      ...
      <div class="inner-box">
        ...
        <div class="forms-wrap">
          ...
          <form action="index.html" autocomplete="off" class="sign-in-form">
            ...
            <div class="actual-form">
              ...
              <div class="input-wrap">
                <input
                  id="name" type="text" minlength="4" autocomplete="off" required
                  class="input-field"
                >
          ...
          <form action="index.html" autocomplete="off" class="sign-up-form">
            ...
            <div class="actual-form">
              ...
              <div class="input-wrap">
                <input
                  id="sign-name" type="text" minlength="4" autocomplete="off" required
                  class="input-field"
                >
              ...
              <div class="input-wrap">
                <input
                  id="sign-password" type="password" autocomplete="off" required
                  class="input-field"
                >
              ...
              <!-- 同意服务条款和隐私协议的复选框 -->
              <p class="text">
                <input id="" type="checkbox" name="">注册前我已阅读并同意
        ...
        <div class="carousel">
          ...
          <div class="images-wrapper">
            ...
            >
            <img
              src="https://wallpaper-static.cheetahfun.com/wallpaper/sites/scifi/pic5.jpg" alt=""
              class="image img-2"
            >
            <img
