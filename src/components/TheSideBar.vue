...
<template>
  <div class="sidebar" :class="{ collapse: isMeetWidth }">
    ...
    <a class="logo-expand" href="#">室内设计</a>
    ...
    <div class="side-wrapper">
      ...
      <div class="menu">
        ...
        <router-link to="/material" active-class="active">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
        ...
        <router-link to="/course" active-class="active">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
        ...
        <router-link to="/forum" active-class="active">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
              fill-rule="evenodd" clip-rule="evenodd"
